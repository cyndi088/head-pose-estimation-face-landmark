...
# sys.path.append('/home/lisheng/caffe/python')
import caffe
...
# Model related:
model_path = 'D:/caffe/人脸检测，特征点标定caffe实现/DeepFace-master/FaceDetection/try1_4/'
...
def face_detection_image(net, net_vf, image_name):
    ...
    for box in true_boxes:
        ...
        if im_crop.shape[0] == 0 or im_crop.shape[1] == 0:
            continue
        if re_verify(net_vf, im_crop) is True:
...
if __name__ == "__main__":
    ...
    for i in range(210):
        image_name = 'D:/caffe/人脸检测，特征点标定caffe实现/DeepFace-master/FaceDetection/baseline/' + str(i + 1) + '.jpg'
        print(i)
